   ...
   public function actionPdfcartas($id){
            ...
            $pdf->SetHTMLHeader('
                <table style="vertical-align: bottom; font-family: serif; font-size: 8pt; color: #000000; font-weight: bold; font-style: italic;">
                    <tr>
                        <td width="20%" align="center" style="font-family: Helvetica;font-weight: bold; font-size: 175%;"> <img src = "../../attendance/web/img/logo-brasil.jpg" height="90px" width="90px"> </td>
                        ...
                        <td width="20%" align="center" style="font-family: Helvetica;font-weight: bold; font-size: 175%;"> <img src = "../../attendance/web/img/ufam.jpg" height="90px" width="70px"> </td>
                    </tr>
                </table>
                <hr>
            ');
    ...
    while($i<count($recomendacao)){
        ...
        $mudarDiretorioParaattendance = "../../attendance/web/";
        $localArquivo = $mudarDiretorioParaattendance.$candidato->getDiretorio();
